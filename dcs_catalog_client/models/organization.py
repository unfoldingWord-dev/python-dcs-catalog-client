...
class Organization(object):
    ...
    attribute_map = {
        ...
        'repo_subjects': 'repo_subjects',
        'username': 'username',
        'visibility': 'visibility',
        'website': 'website'
    }

    def __init__(self, avatar_url=None, description=None, full_name=None, id=None, location=None, repo_admin_change_team_access=None, repo_languages=None, repo_subjects=None, username=None, visibility=None, website=None, _configuration=None):  # noqa: E501
        ...
        self._repo_languages = None
        self._repo_subjects = None
        self._username = None
        ...
        if repo_languages is not None:
            self.repo_languages = repo_languages
        if repo_subjects is not None:
    ...
    @property
    def repo_languages(self):
        """Gets the repo_languages of this Organization.  # noqa: E501

        DCS Customizations ***/  # noqa: E501

        :return: The repo_languages of this Organization.  # noqa: E501
        :rtype: list[str]
        """
        return self._repo_languages

    @repo_languages.setter
    def repo_languages(self, repo_languages):
        """Sets the repo_languages of this Organization.

        DCS Customizations ***/  # noqa: E501

        :param repo_languages: The repo_languages of this Organization.  # noqa: E501
        :type: list[str]
        """

        self._repo_languages = repo_languages

    @property
    def repo_subjects(self):
        """Gets the repo_subjects of this Organization.  # noqa: E501


        :return: The repo_subjects of this Organization.  # noqa: E501
        :rtype: list[str]
        """
        return self._repo_subjects

    @repo_subjects.setter
    def repo_subjects(self, repo_subjects):
        """Sets the repo_subjects of this Organization.


        :param repo_subjects: The repo_subjects of this Organization.  # noqa: E501
        :type: list[str]
        """

        self._repo_subjects = repo_subjects
