...
------------- | ------------- | -------------
[**catalo4_search_owner**](V4Api.md#catalo4_search_owner) | **GET** /v4/search/{owner} | Catalog search by owner
[**catalog_get_entry**](V4Api.md#catalog_get_entry) | **GET** /v4/entry/{owner}/{repo}/{tag} | Catalog entry
[**catalog_get_metadata**](V4Api.md#catalog_get_metadata) | **GET** /v4/entry/{owner}/{repo}/{tag}/metadata | Catalog entry metadata (manifest.yaml in JSON format)
[**catalog_search**](V4Api.md#catalog_search) | **GET** /v4/search | Catalog search
[**catalog_search_repo**](V4Api.md#catalog_search_repo) | **GET** /v4/search/{owner}/{repo} | Catalog search by repo


# **catalo4_search_owner**
> CatalogSearchResultsV4 catalo4_search_owner(owner, q=q, repo=repo, tag=tag, lang=lang, stage=stage, subject=subject, checking_level=checking_level, book=book, include_history=include_history, include_metadata=include_metadata, show_ingredients=show_ingredients, sort=sort, order=order, page=page, limit=limit)
...
try:
    # Catalog search by owner
    api_response = api_instance.catalo4_search_owner(owner, q=q, repo=repo, tag=tag, lang=lang, stage=stage, subject=subject, checking_level=checking_level, book=book, include_history=include_history, include_metadata=include_metadata, show_ingredients=show_ingredients, sort=sort, order=order, page=page, limit=limit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling V4Api->catalo4_search_owner: %s\n" % e)
```
...
# **catalog_get_entry**
> CatalogV4 catalog_get_entry(owner, repo, tag)
...
try:
    ...
    print("Exception when calling V4Api->catalog_get_entry: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling V4Api->catalog_get_metadata: %s\n" % e)
```
...
# **catalog_search_repo**
> CatalogSearchResultsV4 catalog_search_repo(owner, repo, q=q, tag=tag, lang=lang, stage=stage, subject=subject, checking_level=checking_level, book=book, include_history=include_history, include_metadata=include_metadata, show_ingredients=show_ingredients, sort=sort, order=order, page=page, limit=limit)
...
try:
    # Catalog search by repo
    api_response = api_instance.catalog_search_repo(owner, repo, q=q, tag=tag, lang=lang, stage=stage, subject=subject, checking_level=checking_level, book=book, include_history=include_history, include_metadata=include_metadata, show_ingredients=show_ingredients, sort=sort, order=order, page=page, limit=limit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling V4Api->catalog_search_repo: %s\n" % e)
```
